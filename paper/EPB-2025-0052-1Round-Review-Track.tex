...
%DIF ADD Manuscript-Data-Package-1Round-Review.tex   Thu Jun 19 17:47:43 2025
...
extracted from \DIFdelbegin \DIFdel{cycles }\DIFdelend \DIFaddbegin \DIFadd{Cycles }\DIFaddend 2 (1986), 7 (1992), 12 (1998), 19 (2005), 24
(2010), \DIFdelbegin \DIFdel{and }\DIFdelend 29 (2015)\DIFdelbegin \DIFdel{of Canada's }\DIFdelend \DIFaddbegin \DIFadd{, and 34 (2022) of the Time Use Survey (TUS) from the
}\DIFaddend General Social Survey \DIFaddbegin \DIFadd{(GSS)}\DIFaddend . Active travel \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{episodes are }\DIFaddend characterized by
...
2 (1986), 7 (1992), 12 (1998), 19 (2005), 24 (2010), \DIFdelbegin \DIFdel{and }\DIFdelend 29 (2015)\DIFdelbegin \DIFdel{of the GSS}\DIFdelend \DIFaddbegin \DIFadd{, and 34
(2022) of the TUS}\DIFaddend . Time use data in these surveys is coded using a very
...
\DIFdelbegin \DIFdel{For \{ActiveCA\} and using GSS }\DIFdelend \DIFaddbegin \DIFadd{Using }\DIFaddend Public Use Microdata Files (PUMFs) \DIFaddbegin \DIFadd{from the TUS}\DIFaddend , we extracted all
data \DIFdelbegin \DIFdel{needed }\DIFdelend \DIFaddbegin \DIFadd{necessary }\DIFaddend to characterize active travel in Canada \DIFdelbegin \DIFdel{,
namely, episodes where the activity was identified as }\DIFdelend \DIFaddbegin \DIFadd{- specifically,
episodes in which the activity involved }\DIFaddend moving between an origin and a
destination \DIFdelbegin \DIFdel{, either }\DIFdelend by walking or cycling. Although Statistics Canada \DIFdelbegin \DIFdel{offers Public Use Microdata Files and }\DIFdelend \DIFaddbegin \DIFadd{provides
PUMFs and accompanying }\DIFaddend documentation for the GSS program
...
a \DIFdelbegin \emph{\DIFdel{Main File}} %DIFAUXCMD
\DIFdel{and an }\emph{\DIFdel{Episode File}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{main file and an episode file}\DIFaddend . The files are linked by keys that
...
The \DIFdelbegin \DIFdel{Main File }\DIFdelend \DIFaddbegin \DIFadd{main file }\DIFaddend of the time use survey compiles a large array of
...
\DIFdelbegin \DIFdel{Main File }\DIFdelend \DIFaddbegin \DIFadd{main file }\DIFaddend provides a overview of daily routines and social dynamics, not
...
six variables of the \DIFdelbegin \DIFdel{GSS }\DIFdelend \DIFaddbegin \DIFadd{TUS }\DIFaddend PUMF 2015 \DIFdelbegin \DIFdel{Main File }\DIFdelend \DIFaddbegin \DIFadd{main file }\DIFaddend (Cycle 29). Each row in the
table correspond to a survey respondent, while the columns refer the
following information: record identification (\DIFdelbegin \DIFdel{PUMFID}\DIFdelend \DIFaddbegin \texttt{\DIFadd{PUMFID}}\DIFaddend ), the
...
The \DIFdelbegin \DIFdel{Main File }\DIFdelend \DIFaddbegin \DIFadd{main file }\DIFaddend of the 2015 GSS surveys includes a total of 17,390
...
\DIFdelbegin %DIFDELCMD < \begingroup\fontsize{8}{10}\selectfont
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{table}
\centering
\caption{\label{tab:gss-main-file-2015}\label{tab:main-2015-unprocessed}\DIFaddFL{Visualization of the first ten lines and first six columns of the Main file of the 2015 GSS.}}
\centering
...
%DIFDELCMD < \begin{longtable}[t]{cccccc}
...
whom. The focus of the \DIFdelbegin \DIFdel{Episode File }\DIFdelend \DIFaddbegin \DIFadd{episode file }\DIFaddend is not on the characteristics of the
...
included within the \DIFdelbegin \DIFdel{Episode File}\DIFdelend \DIFaddbegin \DIFadd{episode file}\DIFaddend , it is possible to link the \DIFdelbegin \DIFdel{Main File
and the Episode File }\DIFdelend \DIFaddbegin \DIFadd{main file
and the episode file }\DIFaddend by using a key present in both the \DIFdelbegin \DIFdel{Main and
Episode
Files}\DIFdelend \DIFaddbegin \DIFadd{main and
episodes files}\DIFaddend .

Similar to Table \ref{tab:main-2015-unprocessed}, which displayed an
example of the \DIFdelbegin \DIFdel{Main File }\DIFdelend \DIFaddbegin \DIFadd{main file }\DIFaddend structure, Table \ref{tab:ep-2015-unprocessed}
presents the first seven episodes for the record identification number
10041 and some variables from the \DIFdelbegin \DIFdel{GSS }\DIFdelend \DIFaddbegin \DIFadd{TUS }\DIFaddend PUMF 2015 \DIFdelbegin \DIFdel{Episode File }\DIFdelend \DIFaddbegin \DIFadd{episode file }\DIFaddend (Cycle 29).
Each row in the table corresponds to an episode associated with the
specified record identification (\DIFdelbegin \DIFdel{PUMFID }\DIFdelend \DIFaddbegin \texttt{\DIFadd{PUMFID}} \DIFaddend = \DIFdelbegin \DIFdel{10041}\DIFdelend \DIFaddbegin \texttt{\DIFadd{10041}}\DIFaddend ),
including the episode's weight (\DIFdelbegin \DIFdel{WGHT\_EPI}\DIFdelend \DIFaddbegin \texttt{\DIFadd{WGHT\_EPI}}\DIFaddend ), episode number
(\DIFdelbegin \DIFdel{EPINO}\DIFdelend \DIFaddbegin \texttt{\DIFadd{EPINO}}\DIFaddend ), activity code (\DIFdelbegin \DIFdel{TUI\_01}\DIFdelend \DIFaddbegin \texttt{\DIFadd{TUI\_01}}\DIFaddend ), episode duration
(\DIFdelbegin \DIFdel{DURATION}\DIFdelend \DIFaddbegin \texttt{\DIFadd{DURATION}}\DIFaddend ), and episode location (\DIFdelbegin \DIFdel{LOCATION}\DIFdelend \DIFaddbegin \texttt{\DIFadd{LOCATION}}\DIFaddend ).

In total, the \DIFdelbegin \DIFdel{Episode File }\DIFdelend \DIFaddbegin \DIFadd{episode file }\DIFaddend of the 2015 GSS surveys contains 274,108
records, representing 461,837,622 episodes and 527 variables detailing
the episodes. Similar to the \DIFdelbegin \DIFdel{Main File}\DIFdelend \DIFaddbegin \DIFadd{main file}\DIFaddend , Statistics Canada has created
...
\DIFdelend \DIFaddbegin \begin{table}
\centering
\caption{\label{tab:gss-epi-file-2015}\label{tab:ep-2015-unprocessed}\DIFaddFL{Visualization of the seven first episodes of the record number 10041.}}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{8}{10}\selectfont
\begin{threeparttable}
...
%DIFAUXCMD
%DIFDELCMD < \item %%%
\DIFdel{Legend: PUMFID: record identification. EPINO: episode number. WGHT\_EPI: episode's weight. TUI\_01: activity code. DURATION: episode's duration. LOCATION: episode's location.
}%DIFDELCMD < \end{TableNotes}
%DIFDELCMD < \begin{longtable}[t]{cccccc}
%DIFDELCMD < \caption{\label{tab:gss-epi-file-2015}\label{tab:ep-2015-unprocessed}Visualization of the seven first episodes of the record number 10041.}\\
%DIFDELCMD < \toprule
%DIFDELCMD < PUMFID & EPINO & WGHT\_EPI & TUI\_01 & DURATION & LOCATION\\
%DIFDELCMD < \midrule
%DIFDELCMD < 10041 & 1 & 1353.818 & 1 & 210 & 300\\
%DIFDELCMD < 10041 & 2 & 1353.818 & 2 & 40 & 300\\
%DIFDELCMD < 10041 & 3 & 1353.818 & 27 & 15 & 300\\
%DIFDELCMD < 10041 & 4 & 1353.818 & 7 & 15 & 315\\
%DIFDELCMD < 10041 & 5 & 1353.818 & 9 & 180 & 300\\
%DIFDELCMD < \addlinespace
%DIFDELCMD < 10041 & 6 & 1353.818 & 6 & 15 & 300\\
%DIFDELCMD < 10041 & 7 & 1353.818 & 18 & 120 & 300\\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \insertTableNotes
%DIFDELCMD < \end{longtable}
%DIFDELCMD < \end{ThreePartTable}
%DIFDELCMD < \endgroup{}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \section{\DIFadd{Data process}}\label{data-process}
\DIFaddend 

\DIFdelbegin \section{\DIFdel{Data extraction}}%DIFAUXCMD
\addtocounter{section}{-1}%DIFAUXCMD
%DIFDELCMD < \label{data-extraction}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{For each selected cycleof the GSS surveys}\DIFdelend \DIFaddbegin \DIFadd{Figure \ref{fig:process-figure} presents a diagram illustrating the
processes applied to the main and episode files to create the
\{ActiveCA\} datasets. For each TUS cycle}\DIFaddend , we reviewed the \DIFdelbegin \DIFdel{Episode
Files to identify episodes of movement that involved }\DIFdelend \DIFaddbegin \DIFadd{episode files
to identify movement episodes involving }\DIFaddend walking or cycling. This allowed
us to \DIFaddbegin \DIFadd{also }\DIFaddend select the activities immediately before and after the
movement episode\DIFdelbegin \DIFdel{. After that, }\DIFdelend \DIFaddbegin \DIFadd{, helping to infer the trip's purpose and determine its
...
For \DIFdelbegin \DIFdel{each GSS Main File}\DIFdelend \DIFaddbegin \DIFadd{the main files}\DIFaddend , we selected socioeconomic variables to help profile
\DIFdelbegin \DIFdel{the }\DIFdelend individuals engaged in active \DIFdelbegin \DIFdel{trip episodes. We included key
socioeconomic variables such as the respondent's }\DIFdelend \DIFaddbegin \DIFadd{travel episodes. These included key
indicators such as }\DIFaddend age group, sex, marital status, and number of
children, among others. \DIFdelbegin \DIFdel{After this, as we did with the Episode Files}\DIFdelend \DIFaddbegin \DIFadd{As with the episode files}\DIFaddend , we labeled \DIFdelbegin \DIFdel{the code variableswith their appropriate
...
or weighting factor. Because of this, estimates of the number of episodes or persons need to
be calculated applying the corresponding
weighting factors.
}%DIFDELCMD < 
...
WGHT\_PER. The code below demonstrates how to obtain the percentage of people with active travel episodes by age group. It uses the dplyr
...
groups}\DIFdelend \DIFaddbegin \DIFadd{This section presents some potential applications of the \{ActiveCA\} R
...
processed for Main and \DIFdelbegin \DIFdel{Episode Files}\DIFdelend \DIFaddbegin \DIFadd{episode files}\DIFaddend . For the \DIFdelbegin \DIFdel{Main Files}\DIFdelend \DIFaddbegin \DIFadd{main files}\DIFaddend , a total of
\DIFdelbegin \DIFdel{89,331 }\DIFdelend \DIFaddbegin \DIFadd{101,667 }\DIFaddend records were processed, referring to all records from the Time
Use Surveys from 1986 to \DIFdelbegin \DIFdel{2015}\DIFdelend \DIFaddbegin \DIFadd{2022}\DIFaddend , that together represents more of
...
\DIFdelbegin %DIFDELCMD < \begingroup\fontsize{10}{12}%%%
\DIFdelend \DIFaddbegin \begin{table}
\centering
\caption{\label{tab:table_df_processed}\label{tab:processed-obs}\DIFaddFL{Total number and weighted sum of records processed.}}
\centering
\fontsize{8}{10}\DIFaddendFL \selectfont
\DIFaddbeginFL \begin{tabular}[t]{rr>{}r|rr}
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{\DIFaddFL{Main}} & \multicolumn{2}{c}{\DIFaddFL{Episode}} \\
\cmidrule\DIFaddFL{(l}{\DIFaddFL{3pt}}\DIFaddFL{r}{\DIFaddFL{3pt}}\DIFaddFL{)}{\DIFaddFL{2-3}} \cmidrule\DIFaddFL{(l}{\DIFaddFL{3pt}}\DIFaddFL{r}{\DIFaddFL{3pt}}\DIFaddFL{)}{\DIFaddFL{4-5}}
\DIFaddFL{Year }& \DIFaddFL{Count }& \DIFaddFL{Weighted }& \DIFaddFL{Count\_ep }& \DIFaddFL{Weighted\_ep}\\
\midrule
\DIFaddFL{2022 }& \DIFaddFL{12336 }& \DIFaddFL{32136802 }& \DIFaddFL{1765 }& \DIFaddFL{6041032}\\
\DIFaddFL{2015 }& \DIFaddFL{17390 }& \DIFaddFL{29766399 }& \DIFaddFL{3496 }& \DIFaddFL{6634387}\\
\DIFaddFL{2010 }& \DIFaddFL{15390 }& \DIFaddFL{28075610 }& \DIFaddFL{4615 }& \DIFaddFL{8516753}\\
\DIFaddFL{2005 }& \DIFaddFL{19597 }& \DIFaddFL{26095819 }& \DIFaddFL{5866 }& \DIFaddFL{7583838}\\
\DIFaddFL{1998 }& \DIFaddFL{10749 }& \DIFaddFL{24260137 }& \DIFaddFL{1789 }& \DIFaddFL{3606987}\\
\addlinespace
\DIFaddFL{1992 }& \DIFaddFL{9815 }& \DIFaddFL{21294313 }& \DIFaddFL{1635 }& \DIFaddFL{3691918}\\
\DIFaddFL{1986 }& \DIFaddFL{16390 }& \DIFaddFL{19897562 }& \DIFaddFL{4347 }& \DIFaddFL{8241196}\\
\bottomrule
\end{tabular}
\end{table}
\DIFaddend 
...
%DIFDELCMD < %%%
\DIFdelend Table \ref{tab:main-2015-processed} shows the first ten rows and first
...
identification number \DIFdelbegin \DIFdel{10041 from the GSS }\DIFdelend \DIFaddbegin \texttt{\DIFadd{10041}} \DIFadd{from the TUS }\DIFaddend PUMF 2015 \DIFdelbegin \DIFdel{Episode File }\DIFdelend \DIFaddbegin \DIFadd{episode file
}\DIFaddend (Cycle 29), previously displayed in Table \ref{tab:ep-2015-unprocessed}.
...
\DIFdelend \DIFaddbegin \begin{table}
\centering
\caption{\label{tab:gss-processed-file-2015}\label{tab:main-2015-processed}\DIFaddFL{Visualization of the first ten lines and first six columns of the 2015 TUS Main File.}}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{8}{10}\selectfont
\begin{threeparttable}
...
\DIFdelend \DIFaddbegin \begin{table}
\centering
\caption{\label{tab:gss-processed-file-2015}\label{tab:ep-2015-processed}\DIFaddFL{Visualization of the active travel episode for the record number 10041 of the 2015 GSS survey.}}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{8}{10}\selectfont
\begin{threeparttable}
...
%DIFDELCMD < \begin{longtable}[t]{rrlrlll}
...
%DIFDELCMD < %%%
\DIFdelend \subsection{Descriptive statistics}\label{descriptive-statistics}
...
\DIFdelend \DIFaddbegin \begin{table}
\centering
\caption{\label{tab:table-01}\label{tab:table-01}\DIFaddFL{Descriptive statistics for episodes with active transport records}}
\centering
\fontsize{8}{10}\DIFaddendFL \selectfont
\DIFaddbeginFL \begin{tabular}[t]{>{}llccccccc}
\toprule
\multicolumn{2}{c}{ } & \multicolumn{7}{c}{\DIFaddFL{Year}} \\
\cmidrule\DIFaddFL{(l}{\DIFaddFL{3pt}}\DIFaddFL{r}{\DIFaddFL{3pt}}\DIFaddFL{)}{\DIFaddFL{3-9}}
\DIFaddFL{Mode }& \DIFaddFL{Statistic }& \DIFaddFL{1986 }& \DIFaddFL{1992 }& \DIFaddFL{1998 }& \DIFaddFL{2005 }& \DIFaddFL{2010 }& \DIFaddFL{2015 }& \DIFaddFL{2022}\\
\midrule
 & \DIFaddFL{Maximum }& \DIFaddFL{660 }& \DIFaddFL{300 }& \DIFaddFL{255 }& \DIFaddFL{515 }& \DIFaddFL{480 }& \DIFaddFL{900 }& \DIFaddFL{480}\\
\DIFaddendFL 

 \DIFdelbeginFL %DIFDELCMD < \begin{longtable}[t]{>{}llccccccc}
%DIFDELCMD < \caption{\label{tab:table-01}\label{tab:table-01}Descriptive statistics for episodes with active transport records}\\
%DIFDELCMD < \toprule
%DIFDELCMD < \multicolumn{2}{c}{ } & \multicolumn{7}{c}{Year} \\
%DIFDELCMD < \cmidrule(l{3pt}r{3pt}){3-9}
%DIFDELCMD < Mode & Statistic & 1986 & 1992 & 1998 & 2005 & 2010 & 2015 & 2022\\
%DIFDELCMD < \midrule
%DIFDELCMD <  & Maximum & 660 & 300 & 255 & 515 & 480 & 900 & 480\\
%DIFDELCMD < \nopagebreak
%DIFDELCMD <  & Mean & 21 & 21 & 12 & 12 & 13 & 18 & 19\\
%DIFDELCMD < \nopagebreak
%DIFDELCMD <  & Median & 15 & 10 & 5 & 10 & 10 & 10 & 15\\
%DIFDELCMD < \nopagebreak
%DIFDELCMD <  & Minimum & 1 & 1 & 1 & 0 & 0 & 5 & 5\\
%DIFDELCMD < \nopagebreak
%DIFDELCMD < \multirow[t]{-5}{*}{\raggedright\arraybackslash \textbf{Walking}} & Standard deviation & 31 & 25 & 17 & 16 & 17 & 27 & 24\\
%DIFDELCMD < \cmidrule{1-9}\pagebreak[0]
%DIFDELCMD <  & Maximum &  & 240 & 90 & 180 & 153 & 120 & 150\\
%DIFDELCMD < \nopagebreak
%DIFDELCMD <  & Mean &  & 28 & 24 & 20 & 19 & 25 & 40\\
%DIFDELCMD < \nopagebreak
%DIFDELCMD <  & Median &  & 15 & 15 & 15 & 10 & 20 & 30\\
%DIFDELCMD < \nopagebreak
%DIFDELCMD <  & Minimum &  & 5 & 2 & 1 & 1 & 5 & 5\\
%DIFDELCMD < \nopagebreak
%DIFDELCMD < \multirow[t]{-5}{*}{\raggedright\arraybackslash \textbf{Cycling}} & Standard deviation &  & 36 & 18 & 18 & 23 & 20 & 20\\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{longtable}
%DIFDELCMD < \endgroup{}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL & \DIFaddFL{Mean }& \DIFaddFL{21 }& \DIFaddFL{21 }& \DIFaddFL{12 }& \DIFaddFL{12 }& \DIFaddFL{13 }& \DIFaddFL{18 }& \DIFaddFL{19}\\
\DIFaddendFL 

 \DIFaddbeginFL & \DIFaddFL{Median }& \DIFaddFL{15 }& \DIFaddFL{10 }& \DIFaddFL{5 }& \DIFaddFL{10 }& \DIFaddFL{10 }& \DIFaddFL{10 }& \DIFaddFL{15}\\

 & \DIFaddFL{Minimum }& \DIFaddFL{1 }& \DIFaddFL{1 }& \DIFaddFL{1 }& \DIFaddFL{0 }& \DIFaddFL{0 }& \DIFaddFL{5 }& \DIFaddFL{5}\\

\multirow[t]{-5}{*}{\raggedright\arraybackslash \textbf{Walking}} & \DIFaddFL{Standard deviation }& \DIFaddFL{31 }& \DIFaddFL{25 }& \DIFaddFL{17 }& \DIFaddFL{16 }& \DIFaddFL{17 }& \DIFaddFL{27 }& \DIFaddFL{24}\\
\cmidrule{1-9}
 & \DIFaddFL{Maximum }&  & \DIFaddFL{240 }& \DIFaddFL{90 }& \DIFaddFL{180 }& \DIFaddFL{153 }& \DIFaddFL{120 }& \DIFaddFL{150}\\

 & \DIFaddFL{Mean }&  & \DIFaddFL{28 }& \DIFaddFL{24 }& \DIFaddFL{20 }& \DIFaddFL{19 }& \DIFaddFL{25 }& \DIFaddFL{40}\\

 & \DIFaddFL{Median }&  & \DIFaddFL{15 }& \DIFaddFL{15 }& \DIFaddFL{15 }& \DIFaddFL{10 }& \DIFaddFL{20 }& \DIFaddFL{30}\\

 & \DIFaddFL{Minimum }&  & \DIFaddFL{5 }& \DIFaddFL{2 }& \DIFaddFL{1 }& \DIFaddFL{1 }& \DIFaddFL{5 }& \DIFaddFL{5}\\

\multirow[t]{-5}{*}{\raggedright\arraybackslash \textbf{Cycling}} & \DIFaddFL{Standard deviation }&  & \DIFaddFL{36 }& \DIFaddFL{18 }& \DIFaddFL{18 }& \DIFaddFL{23 }& \DIFaddFL{20 }& \DIFaddFL{20}\\
\bottomrule
\end{tabular}
\end{table}

\DIFaddend Table \ref{tab:table-01} shows that, \DIFdelbegin \DIFdel{in general, }\DIFdelend \DIFaddbegin \DIFadd{until 2022 }\DIFaddend the median values for
...
highest proportion of trips }\DIFdelend \DIFaddbegin \DIFadd{2022, home location served as a central hub for most trips, with
fewer than 10\% of journeys not involving it as either a starting point
or destination. The most common trip types }\DIFaddend were from home to work or
school (\DIFdelbegin \DIFdel{12}\DIFdelend \DIFaddbegin \DIFadd{17}\DIFaddend \%) and \DIFdelbegin \DIFdel{vice versa (11}\DIFdelend \DIFaddbegin \DIFadd{the reverse, from work or school to home (13}\DIFaddend \%).
\DIFdelbegin \DIFdel{home to home accounted for 8}\DIFdelend \DIFaddbegin \DIFadd{Notably, 7}\DIFaddend \% of trips \DIFdelbegin \DIFdel{, and grocery
stores became a notable destinationfor those leaving home (6\%), surpassing trips to other's home(4\%)}\DIFdelend \DIFaddbegin \DIFadd{began and ended at home, often reflecting leisure
activities such as short walks or dog walking. Grocery stores were also
a key destination, comprising 10\% of trips departing from home}\DIFaddend .
...
Pandas \DIFdelbegin \DIFdel{DataFrames}\DIFdelend \DIFaddbegin \DIFadd{Data Frames}\DIFaddend . This process allows users to work with and utilize
