...
load(paste0(here(), "/data/cycling_data_f.Rda"))
load(paste0(here(), "/data/walking_data.Rda"))
load(paste0(here(), "/data/walking_data_f.Rda"))
...
load(paste0(here(), "/data/trip.Rda"))
```
...
Presented as Equation \ref{eq:ch03-equation-06} [@wu2019measuring]:
...
# Replace NA in MODE with "walking"
final_data$MODE <- replace_na(final_data$MODE, "walking")
...
styled_ch03_table_02 <- wide_data %>%
  kable(
    ...
    col.names = c("Destination", "Mode*","Min*","Med*","Max*", "P*", "Min","Med","Max", "P", "Min","Med","Max", "P")
  ) %>%
  ...
  add_footnote(c("* The symbols used in this table represent the following: 'Min' denotes the minimum time to reach the destination; 'Max' denotes the maximum time to reach the destination; 'P' indicates a percentage of the total time to reach the destination; 'Med' refers to the median time to reach the destination."))
...
trip <- trip %>%
  mutate(dest_label = case_when(
    ...
    dest_label == "In the neighbourhood" ~ "Outdoors",
...
```{r ch03-make-Heatmap-walking_2010, echo=FALSE, cache=FALSE, include=FALSE}
...
```{r ch03-make-Heatmap-walking_2005, echo=FALSE, cache=FALSE, include=FALSE}
...
```{r ch03-make-Heatmap-walking_1998, echo=FALSE, cache=FALSE, include=FALSE} 
...
```{r ch03-make-Heatmap-walking_1992, echo=FALSE, cache=FALSE, include=FALSE}
...
```{r ch03-make-Heatmap-walking_1986, echo=FALSE, cache=FALSE, include=FALSE}
...
```{r ch03-make-Heatmap-cycling_2015,echo=FALSE, cache=FALSE, include=FALSE }
...
```{r ch03-make-Heatmap-cycling_2010,echo=FALSE, cache=FALSE, include=FALSE }
...
```{r ch03-make-Heatmap-cycling_2005,echo=FALSE, cache=FALSE, include=FALSE }
...
```{r ch03-make-Heatmap-cycling_1998,echo=FALSE, cache=FALSE, include=FALSE }
...
```{r ch03-make-Heatmap-cycling_1992,echo=FALSE, cache=FALSE, include=FALSE }
...
```{r ch03-make-fig-01, include=FALSE}
...
```{r ch03-plot-fig-01, echo=FALSE, out.width="100%", fig.cap="Percentage of walking Trips Categorized by Origin and Destination", fig.align="center"}

knitr::include_graphics("figure/ch03_fig_01.jpg")
```

```{r ch03-make-fig-02, include=FALSE}
...
```{r ch03-plot-fig-02, echo=FALSE, out.width="100%", fig.cap="Percentage of cycling Trips Categorized by Origin and Destination", fig.align="center"}
...
```{r ch03-make-table-04, echo=FALSE, cache=FALSE, warning=FALSE, message=FALSE}
...
walking_data_filtered |> 
  ...
  kable(format = "latex",
        booktabs = TRUE,
        caption = "\\label{tab:ch03-table-04}Impedance functions and selection criteria across destinations for walking trips (1986, 1992 and 1998)") |>
...
```{r ch03-make-table-05, echo=FALSE, cache=FALSE, warning=FALSE, message=FALSE}
...
walking_data_filtered |> 
  ...
  kable(format = "latex",
        booktabs = TRUE,
        caption = "\\label{tab:ch03-table-05}Impedance functions and selection criteria across destinations for walking trips (2005, 2010, 2015)") |>
...
```{r ch03-make-table-06, echo=FALSE, cache=FALSE, warning=FALSE, message=FALSE}
...
```{r ch03-make-table-07, echo=FALSE, cache=FALSE, warning=FALSE, message=FALSE}
...
cycling_data_filtered |> 
  ...
  kable(format = "latex",
        booktabs = TRUE,
        caption = "\\label{tab:ch03-table-07}Impedance functions and selection criteria across destinations for cycling trips (1992 and 1998)") |>
...
```{r ch03-make-table-08, echo=FALSE, cache=FALSE, warning=FALSE, message=FALSE}
...
cycling_data_filtered |> 
  ...
  kable(format = "latex",
        booktabs = TRUE,
        caption = "\\label{tab:ch03-table-08}Impedance functions and selection criteria across destinations for cycling trips (2005, 2010 and 2015)") |>
  kable_styling(font_size = 11) |> 
  pack_rows("Destination: Home", 1, 9) |> 
...
```{r ch03-make-table-09, echo=FALSE, cache=FALSE, warning=FALSE, message=FALSE}
# Filter the dataframe to only include specific destinations
...
```{r ch03-make-impedance_graph_walking_home ,cache=FALSE, message=FALSE, echo=FALSE, include=FALSE}
...
```{r ch03-make-impedance_graph_cycling_home ,cache=FALSE, message=FALSE, echo=FALSE, include=FALSE}
...
```{r ch03-make-fig-03, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-03, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to home destinations", fig.align="center"}
...
```{r ch03-make-impedance_graph_walking_work, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
# Filter out NA values if necessary
walking_data_f <- walking_data_f %>% filter(!is.na(f_t))
...
```{r ch03-make-impedance_graph_cycling_work, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r ch03-make-fig-04, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-04, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to work or school destinations", fig.align="center"}
...
```{r ch03-make-impedance_graph_walking_other, cache=FALSE,include=FALSE, message=FALSE, echo=FALSE}
# Filter out NA values if necessary
walking_data_f <- walking_data_f %>% filter(!is.na(f_t))
...
```{r ch03-make-impedance_graph_cycling_other, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r ch03-make-fig-05, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-05, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to work or school destinations", fig.align="center"}
...
```{r ch03-make-impedance_graph_walking_grocery, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r ch03-make-impedance_graph_cycling_grocery, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
# Assuming cycling_data_f is already loaded and has 'YEAR', 'DURATION', 'dest_label', and 'f_t' columns
...
```{r ch03-make-fig-06, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-06, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to work or school destinations", fig.align="center"}
...
```{r ch03-make-impedance_graph_walking_outdoors, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
# Assuming walking_data_f is already loaded and has 'YEAR', 'DURATION', 'dest_label', and 'f_t' columns
...
```{r ch03-make-impedance_graph_cycling_outdoors, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
# Assuming cycling_data_f is already loaded and has 'YEAR', 'DURATION', 'dest_label', and 'f_t' columns
...
```{r ch03-make-fig-07, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-07, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to work or school destinations", fig.align="center"}
...
```{r ch03-make-impedance_graph_walking_restaurant, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
# Assuming walking_data_f is already loaded and has 'YEAR', 'DURATION', 'dest_label', and 'f_t' columns
...
```{r ch03-make-impedance_graph_cycling_restaurant, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
...
```{r ch03-make-fig-08, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-08, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to work or school destinations", fig.align="center"}
...
```{r ch03-make-impedance_graph_walking_place, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
# Assuming walking_data_f is already loaded and has 'YEAR', 'DURATION', 'dest_label', and 'f_t' columns
...
```{r ch03-make-fig-09, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-09, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to work or school destinations"}
...
```{r ch03-make-impedance_graph_walking_library, cache=FALSE, include=FALSE, message=FALSE, echo=FALSE}
# Assuming walking_data_f is already loaded and has 'YEAR', 'DURATION', 'dest_label', and 'f_t' columns
...
```{r ch03-make-fig-010, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-10, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to work or school destinations"}
...
```{r ch03-make-impedance_walking_2015, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_walking_2010, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_walking_2005, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_walking_1998, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_walking_1992, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_walking_1986, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-fig-11, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-11, echo=FALSE, cache=FALSE, out.width="100%", fig.align="center"}

knitr::include_graphics("figure/ch03_fig_11.jpg")
```

```{r ch03-plot-fig-12, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking trips to various destinations", fig.align="center"}
...
```{r ch03-make-impedance_cycling_2015, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_cycling_2010, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_cycling_2005, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_cycling_1998, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-impedance_cycling_1992, echo=FALSE,include=FALSE, message=FALSE, warning=FALSE}
...
```{r ch03-make-fig-13, cache = FALSE, include=FALSE}
...
```{r ch03-plot-fig-13, echo=FALSE, cache=FALSE, out.width="100%", fig.align="center"}

knitr::include_graphics("figure/ch03_fig_13.jpg")
```

```{r ch03-plot-fig-14, echo=FALSE, cache=FALSE, out.width="100%", fig.cap="Modeling distance decay curves of walking and cycling to work or school destinations", fig.align="center"}
