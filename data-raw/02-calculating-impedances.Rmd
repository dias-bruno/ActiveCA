...
Similar as we did before, the next chunk selects the best impedance function, using the `test_distributions_weighted` and `lowest_aic` functions for each destination, transportation mode and year. The name pattern is as follows: `f_year_mode_dest` + `destination`, which means that `f_1986_Walking_dest1` displays the best function for the year 1986, walking mode, destination 1 (Home).
/000
```{r}
