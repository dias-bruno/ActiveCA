...
walking_2015 <- walking_2015 |>
  ...
  mutate(orig_label =
           case_when(origin == 300 ~ "Home", 
                     ...
                     origin %in% c(317,320,321) ~ "Travel - Other",
                     origin == 316 ~ "Travel - Transit",
                     origin == 315 ~ "Travel - Walk",
                     origin == 318 ~ "Travel - Bycicle"),
...
walking_2015 <- walking_2015 |>  
  ...
  mutate(dest_label =
           case_when(destination == 300 ~ "Home", 
                     ...
                     destination %in% c(317,320,321) ~ "Travel - Other",
                     destination == 316 ~ "Travel - Transit",
                     destination == 315 ~ "Travel - Walk",
                     destination == 318 ~ "Travel - Bycicle"),
...
walking_2010 <- walking_2010 |>
  ...
  mutate(orig_label =
           case_when(origin == 1 ~ "Home", 
                     ...
                     origin %in% c(18,20,21) ~ "Travel - Other",
                     origin %in% c(15,16) ~ "Travel - Transit",
                     origin == 14 ~ "Travel - Walk",
                     origin == 17 ~ "Travel - Bycicle"),
         orig_label = factor(orig_label))
```
...
walking_2010 <- walking_2010 |>
  ...
  mutate(dest_label =
           case_when(destination == 1 ~ "Home", 
                     ...
                     destination %in% c(18,20,21) ~ "Travel - Other",
                     destination %in% c(15,16) ~ "Travel - Transit",
                     destination == 14 ~ "Travel - Walk",
                     destination == 17 ~ "Travel - Bycicle"),
         dest_label = factor(dest_label))
```
...
walking_1998 <- walking_1998 |>
  ...
  mutate(orig_label =
           case_when(origin == 1 ~ "Home", 
                     ...
                     origin == 10 ~ "Travel - Other",
                     origin == 8  ~ "Travel - Transit",
                     origin == 7 ~ "Travel - Walk",
                     origin == 9 ~ "Travel - Bycicle"),
         orig_label = factor(orig_label))
```
...
walking_1998 <- walking_1998 |>
  ...
  mutate(dest_label =
           case_when(destination == 1 ~ "Home", 
                     ...
                     destination == 10 ~ "Travel - Other",
                     destination == 8  ~ "Travel - Transit",
                     destination == 7 ~ "Travel - Walk",
                     destination == 9 ~ "Travel - Bycicle"),
         dest_label = factor(dest_label))
```
...
walking_1986 <- walking_1986 |>
  ...
  mutate(orig_label =
           case_when(origin == 1 ~ "Home", 
                     ...
                     origin == 7 ~ "Travel - Other",
                     origin == 6 ~ "Travel - Transit",
                     origin == 5 ~ "Travel - Walk"),
         orig_label = factor(orig_label))
```
  ...
  filter(!is.na(origin)) |>
    mutate(orig_label =
           case_when(origin == 'At home or on property' ~ "Home", 
                     ...
                     origin %in% c('Travel - Airplane', 
                                   'Travel - Other',
                                   'Travel - not stated') ~ "Travel - Other", 
